    ...
    <div>
      <div name='contact' className='w-full h-screen bg-[#f2efea] flex justify-center items-center p-4'>
          <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex flex-col max-w-[600px] w-full'>
              ...
              <button className='text-[#0d0d0d] border-1 hover:bg-[#557373] hover:text-[#f2efea] hover:border-[#0d0d0d] hover:scale-110 duration-500 px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
          </form> 
      </div>
