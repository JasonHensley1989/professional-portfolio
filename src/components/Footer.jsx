    ...
    return (
        <div className='w-full h-screen/2 bg-[#557373] p-4 text-[#f2efea] flex-row'>
            <div className='flex flex-row justify-center space-x-10'>
                ...
                <a href='https://drive.google.com/file/d/11lYl-DvQnMrqCpqcvXGTrAAbceTeuCso/view?usp=sharing' download='https://drive.google.com/file/d/11lYl-DvQnMrqCpqcvXGTrAAbceTeuCso/view?usp=sharing'><BsFillPersonLinesFill size={30} className='hover:scale-110 duration-500'/><span className='mx-[-10px]'>Resume</span></a>              
            </div>     
        </div>
    )
}
