...
const Skills = () => {
  return (
    <div name='skills' className='w-full md:h-[screen + 50px] bg-[#dfe5f3] text-[#557373] pt-[1rem] py-[10%]'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full pt-20 mt-10'>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaHtml5 className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>HTML5</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaCss3Alt className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>CSS3</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaJsSquare className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>JAVASCRIPT</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaReact className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>React</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaGithubSquare className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>GITHUB</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaNodeJs className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>NODE JS</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <SiMongodb className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>MONGO DB</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <DiPostgresql className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>POSTGRESQL</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <FaPython className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>Python</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <SiDjango className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>Django</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <SiExpress className='scale-[5] mx-auto w-10 mt-10' />
                  <p className='my-10'>Express</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500 rounded-lg'>
                  <AiOutlineConsoleSql className='scale-[5] mx-auto w-10 mt-10' />
